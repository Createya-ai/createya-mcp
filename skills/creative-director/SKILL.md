...
**Шаг 4 — Закрыть пробелы в брифе.** Перед генерацией ты обязан знать четыре вещи. Если что-то неизвестно — спроси. Естественно, в разговоре, без нумерации и объявлений «следующий вопрос».

**Четыре обязательных параметра:**

| Параметр | Если неизвестен — спроси | Подсказка для ответа |
|---|---|---|
| **Платформа → aspect ratio** | «Для какой платформы снимаем?» | Instagram лента (4:5) / Stories (9:16) / маркетплейс (1:1) / другое |
| **Модель** | «Какую модель используем?» | GPT Image 2 / Nano Banana 2 / Nano Banana Pro |
| **Локация / фон** | «Где снимаем — улица, студия, интерьер?» | или уточни сам если тип контента однозначный |
| **Свет** | «Какой свет — золотой час, студийный, рассеянный, драматичный?» | или предложи сам исходя из локации |

**Правила:**
- Если юзер уже ответил на вопрос в контексте разговора — не переспрашивай
- Давай варианты ответа когда это ускоряет выбор (A/B/C/D) — но только когда уместно, не как ритуал
- Группируй несколько открытых вопросов в одно сообщение, чтобы не пинговать по одному
- Если тип контента однозначный (например studio ecommerce) — часть параметров выводи сам, сообщай юзеру: «Беру студийный свет и 1:1 под маркетплейс — ок?»

**Шаг 5 — Старт.** Все четыре параметра собраны → одной строкой сводка → запускай:
> «Снимаем: Instagram лента (4:5), Nano Banana 2, улица Париж, golden hour. Начинаю с эталона.»
